 ...
 *	License: MIT
 */(function(e,t,n){var r="babylongrid",i={scheme:[{minWidth:960,columns:4},{minWidth:720,columns:3},{minWidth:500,columns:2},{minWidth:0,columns:1}],display:null,firstToRight:!1},s=function(n,s){this.element=n;this.options=e.extend({},i,s);this._defaults=i;this._name=r;this.init()};s.prototype={init:function(){var n=this;e(this.element).wrapInner('<div class="babylongrid-container" />');this.casheElements();this._setGrid();e(t).resize(function(){n._setGrid()})},casheElements:function(){var t=e(this.element),n=t.children(".babylongrid-container"),r=n.children();this.cashed={element:t,container:n,articles:r}},_setGrid:function(){var t=this.cashed.container,n=t.width(),r,i,s=this;e.each(this.options.scheme,function(){if(this.minWidth<=n){i=this.columns;r="container-"+i;if(!t.hasClass(r)){t.removeClass().addClass("babylongrid-container").addClass(r);s._setColumns(i)}return!1}})},_setColumns:function(e){var t=this.cashed.container,n;t.children(".column").remove();for(var r=1;r<=e;r++){n='<div class="column column-'+r+'"></div>';t.append(n)}t.children(".column").data("height",0);this._organizeArticles(e)},_organizeArticles:function(t){var n=this.cashed.articles,r,i=this.cashed.container,s=i.children(".column"),o=s.data("height")+1,u,a,f=this;f.options.display&&i.removeClass("tower").removeClass("city");f.options.firstToRight&&s.filter(".column-"+t).data("height",-1);e.each(n,function(l){r=e(this);e.each(s,function(n){if(e(this).data("height")<o){o=e(this).data("height");u=e(this)}if(n+1>=t){u.append(r);a=u.outerHeight(!0);u.data("height",a);o=a}});f.options.display&&l+1===n.length&&(f.options.display==="tower"?i.addClass("tower"):f.options.display==="city"&&i.addClass("city"))})}};e.fn[r]=function(t){return this.each(function(){e.data(this,"plugin_"+r)||e.data(this,"plugin_"+r,new s(this,t))})}})(jQuery,window);